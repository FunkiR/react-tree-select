...
export type Theme = Partial<Record<keyof typeof Component, string>>;
...
export type MultiSelectPluginReturnType<P> = ApplyPluginReturnType<Omit<P, 'isSelected' | 'value'>, Props>;
